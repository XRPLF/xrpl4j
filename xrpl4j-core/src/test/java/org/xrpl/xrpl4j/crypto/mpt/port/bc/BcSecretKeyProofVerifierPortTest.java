...
/**
 * Test for {@link BcSecretKeyProofVerifierPort} using C implementation test vectors.
 */
public class BcSecretKeyProofVerifierPortTest {

  private static JsonNode testVectors;
  private static final ObjectMapper objectMapper = new ObjectMapper();
  private final SecretKeyProofVerifierPort verifier = new BcSecretKeyProofVerifierPort();

  @BeforeAll
  static void loadTestVectors() throws Exception {
    InputStream is = BcSecretKeyProofVerifierPortTest.class.getResourceAsStream("/mpt/port/pok_sk_vectors.json");

...
/**
 * BouncyCastle implementation of {@link SamePlaintextProofGeneratorPort}.
 *
 * <p>Port of {@code secp256k1_mpt_prove_same_plaintext_multi} from proof_same_plaintext_multi.c.</p>
 */
public class BcSamePlaintextProofGeneratorPort implements SamePlaintextProofGeneratorPort {
   ...
   */
  public BcSamePlaintextProofGeneratorPort() {
   ...
   */
  public BcSamePlaintextProofGeneratorPort(final BlindingFactorGenerator blindingFactorGenerator) {
  ...
  public UnsignedByteArray generateProof(
    ...
    try {
      ...
      int proofSize = SamePlaintextProofGeneratorPort.proofSize(n);

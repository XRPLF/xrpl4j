...
/**
 * Java implementation of {@link PedersenCommitmentGenerator}.
 *
 * <p>Generates Pedersen Commitments of the form C = v * G + rho * H using a
 * "Nothing-Up-My-Sleeve" (NUMS) construction for the H generator.</p>
 */
public class JavaPedersenCommitmentGenerator implements PedersenCommitmentGenerator {
  ...
  /**
   * Constructs a new JavaPedersenCommitmentGenerator.
   */
  public JavaPedersenCommitmentGenerator() {
  }

  @Override
  public PedersenCommitment generateCommitment(UnsignedLong amount, BlindingFactor rho) {
    ...
    BigInteger rhoInt = new BigInteger(1, rho.toBytes());

...
public interface MetaLoanObject extends MetaLedgerObject {
  ...
  Optional<AssetAmount> totalValueOutstanding();
  ...
  Optional<AssetAmount> principalOutstanding();
  ...
  Optional<AssetAmount> managementFeeOutstanding();
  ...
  Optional<AssetAmount> periodicPayment();

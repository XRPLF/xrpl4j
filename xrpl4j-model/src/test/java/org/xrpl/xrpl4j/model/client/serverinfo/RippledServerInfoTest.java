...
public class RippledServerInfoTest extends AbstractJsonTest {
  ...
  public void testRippledServerInfoJson() throws JsonProcessingException {
    ...
    ServerInfoResult rippledResult = ServerInfoResult.builder()
      .status("success")
      .info(rippledServerInfo("54300020-54300729"))
      .build();
    ...
    assertThat(rippledResult.info().map(($) -> true, ($) -> false, ($) -> false).booleanValue()).isTrue();
   ...
   */
  protected static ServerInfo rippledServerInfo(final String completeLedgers) {

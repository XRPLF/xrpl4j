...
import org.xrpl.xrpl4j.crypto.confidential.bulletproof.bc.BcPlaintextEqualityProofGenerator;
...
public class BcConfidentialMPTClawbackProofGenerator implements ConfidentialMPTClawbackProofGenerator {
  ...
  private final PlaintextEqualityProofGenerator proofGeneratorPort;

  /**
   * Creates a new instance with default port implementation.
   */
  public BcConfidentialMPTClawbackProofGenerator() {
    this(new BcPlaintextEqualityProofGenerator());
  }
   ...
   */
  public BcConfidentialMPTClawbackProofGenerator(final PlaintextEqualityProofGenerator proofGeneratorPort) {

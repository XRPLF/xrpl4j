...
import org.xrpl.xrpl4j.crypto.mpt.wrapper.ConfidentialMPTConvertBackProofVerifier;
...
public class BcConfidentialMPTConvertBackProofVerifier implements ConfidentialMPTConvertBackProofVerifier {
  ...
  public BcConfidentialMPTConvertBackProofVerifier() {
    this(new BcPedersenLinkProofVerifierPort(), new BcRangeProofVerifierPort());
  }
  ...
  public boolean verifyProof(
    ...
    final ElGamalCiphertext encryptedBalance,

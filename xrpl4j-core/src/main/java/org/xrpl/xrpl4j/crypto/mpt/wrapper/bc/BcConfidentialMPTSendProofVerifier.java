...
import org.xrpl.xrpl4j.crypto.mpt.port.SamePlaintextProofVerifierPort;
import org.xrpl.xrpl4j.crypto.mpt.port.bc.BcPedersenLinkProofVerifierPort;
import org.xrpl.xrpl4j.crypto.mpt.port.bc.BcRangeProofVerifierPort;
import org.xrpl.xrpl4j.crypto.mpt.port.bc.BcSamePlaintextProofVerifierPort;
import org.xrpl.xrpl4j.crypto.mpt.wrapper.ConfidentialMPTSendProofVerifier;
...
public class BcConfidentialMPTSendProofVerifier implements ConfidentialMPTSendProofVerifier {
  ...
  private final SamePlaintextProofVerifierPort samePlaintextProofVerifier;
  private final PedersenLinkProofVerifierPort pedersenLinkProofVerifier;
  private final RangeProofVerifierPort rangeProofVerifier;
  ...
  public BcConfidentialMPTSendProofVerifier() {
    this(
      new BcSamePlaintextProofVerifierPort(),
      new BcPedersenLinkProofVerifierPort(),
      new BcRangeProofVerifierPort()
    );
  }
   ...
   */
  public BcConfidentialMPTSendProofVerifier(
    final SamePlaintextProofVerifierPort samePlaintextProofVerifier,
    final PedersenLinkProofVerifierPort pedersenLinkProofVerifier,
    final RangeProofVerifierPort rangeProofVerifier
  ) {

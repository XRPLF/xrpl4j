...
/**
 * Unit tests for {@link VaultDeposit} JSON serialization.
 */
public class VaultDepositJsonTest extends AbstractJsonTest {

  @Test
  public void testVaultDepositJsonWithXrpAmount() throws JsonProcessingException, JSONException {
  ...
  @Test
  public void testVaultDepositJsonWithIssuedCurrencyAmount() throws JsonProcessingException, JSONException {
    VaultDeposit vaultDeposit = VaultDeposit.builder()
      .account(Address.of("rJVUeRqDFNs2xqA7ncVE6ZoAhPUoaJJSQm"))
      .fee(XrpCurrencyAmount.ofDrops(10))
      .sequence(UnsignedInteger.valueOf(1))
  ...
  @Test
  public void testVaultDepositJsonWithMptAmount() throws JsonProcessingException, JSONException {
    VaultDeposit vaultDeposit = VaultDeposit.builder()
      .account(Address.of("rJVUeRqDFNs2xqA7ncVE6ZoAhPUoaJJSQm"))
      .fee(XrpCurrencyAmount.ofDrops(10))
      .sequence(UnsignedInteger.valueOf(1))

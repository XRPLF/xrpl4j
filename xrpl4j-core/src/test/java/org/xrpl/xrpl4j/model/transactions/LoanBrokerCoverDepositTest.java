...
/**
 * Unit tests for {@link LoanBrokerCoverDeposit} validation logic.
 */
class LoanBrokerCoverDepositTest {
  ...
  /**
   * Returns a builder pre-populated with required fields for LoanBrokerCoverDeposit.
   */
  private ImmutableLoanBrokerCoverDeposit.Builder baseBuilder() {
    return LoanBrokerCoverDeposit.builder()

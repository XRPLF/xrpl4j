...
public class BcElGamalDecryptorTest {
  ...
  private ElGamalCiphertext validCiphertext;
  ...
  void decryptWithValidInputs() {
    UnsignedLong result = decryptor.decrypt(validCiphertext, validPrivateKey, UnsignedLong.ZERO, UnsignedLong.valueOf(10));

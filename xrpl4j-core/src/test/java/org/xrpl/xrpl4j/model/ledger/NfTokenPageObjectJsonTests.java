      ...
      .addNfTokens(
        NfTokenWrapper.of(
          NfToken.builder()
            ...
            .uri(NfTokenUri.of("697066733A2F2F62616679626569676479727A74357366703775646D37687537367568377932366E6634646675796C71616266336F636C67747179353566627A6469"))
            .build()
        ),
        NfTokenWrapper.of(
          NfToken.builder()

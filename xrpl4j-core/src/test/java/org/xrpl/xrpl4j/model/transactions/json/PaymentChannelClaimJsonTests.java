...
public class PaymentChannelClaimJsonTests
  extends AbstractTransactionJsonTest<ImmutablePaymentChannelClaim, ImmutablePaymentChannelClaim.Builder, PaymentChannelClaim> {

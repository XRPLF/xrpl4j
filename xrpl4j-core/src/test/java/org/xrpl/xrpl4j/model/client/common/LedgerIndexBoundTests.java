...
public class LedgerIndexBoundTests {
  ...
  void addLedgerIndexToBound() {
    ...
    org.assertj.core.api.Assertions.assertThat(added.value()).isEqualTo(1001);
  }
  ...
  void addLedgerIndexBoundToBound() {
    ...
    org.assertj.core.api.Assertions.assertThat(added1.value()).isEqualTo(1001);
    org.assertj.core.api.Assertions.assertThat(added1).isEqualTo(LedgerIndexBound.of(1001));
    LedgerIndexBound added2 = ledgerIndexBound2.plus(ledgerIndexBound1);
    org.assertj.core.api.Assertions.assertThat(added2.value()).isEqualTo(1001);
    org.assertj.core.api.Assertions.assertThat(added2).isEqualTo(LedgerIndexBound.of(1001));

    org.assertj.core.api.Assertions.assertThat(added2).isEqualTo(added1);
  }
  ...
  void addLongToBound() {
    ...
    org.assertj.core.api.Assertions.assertThat(added).isEqualTo(LedgerIndexBound.of(1001));
    org.assertj.core.api.Assertions.assertThat(added.value()).isEqualTo(1001);
  }
  ...
  void subtractBoundFromBound() {
    ...
    org.assertj.core.api.Assertions.assertThat(subtracted).isEqualTo(LedgerIndexBound.of(100));
    org.assertj.core.api.Assertions.assertThat(subtracted.value()).isEqualTo(100);
  ...
  void subtractLedgerIndexFromBound() {
    ...
    org.assertj.core.api.Assertions.assertThat(subtracted).isEqualTo(LedgerIndexBound.of(100));
    org.assertj.core.api.Assertions.assertThat(subtracted.value()).isEqualTo(100L);
  ...
  void subtractLongFromBound() {
    ...
    org.assertj.core.api.Assertions.assertThat(subtractedLong).isEqualTo(LedgerIndexBound.of(100));
    org.assertj.core.api.Assertions.assertThat(subtractedLong.value()).isEqualTo(100L);

    Integer intValue = 900;
    LedgerIndexBound subtractedInt = ledgerIndexBound.minus(intValue);
    org.assertj.core.api.Assertions.assertThat(subtractedInt).isEqualTo(LedgerIndexBound.of(100));
    org.assertj.core.api.Assertions.assertThat(subtractedInt.value()).isEqualTo(100L);

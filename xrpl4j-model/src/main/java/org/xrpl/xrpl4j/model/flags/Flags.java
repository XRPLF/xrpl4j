...
public class Flags {
   ...
   * of multiple flags.
   */
  public static class AmmDepositFlags extends TransactionFlags {
   ...
   */
  public static class AmmWithdrawFlags extends TransactionFlags {
    ...
    /**
     * Constant {@link AmmDepositFlags} for the {@code tfWithdrawAll} flag.
     */
    public static final AmmWithdrawFlags WITHDRAW_ALL = new AmmWithdrawFlags(0x00020000);

    /**
     * Constant {@link AmmDepositFlags} for the {@code tfOneAssetWithdrawAll} flag.
     */

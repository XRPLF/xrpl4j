...
//      .build();
//    final Address sourceAddress = AddressUtils.getInstance()
//      .deriveAddress(signatureService.getPublicKey(sourceKeyMetadata));
//    this.fundAccount(sourceAddress);
//
//    KeyMetadata aliceKeyMetadata = KeyMetadata.builder().from(KeyMetadata.EMPTY)
//      .keyIdentifier("alice")
//      .build();
//    final Address aliceAddress = AddressUtils.getInstance()
//      .deriveAddress(signatureService.getPublicKey(aliceKeyMetadata));
//    this.fundAccount(aliceAddress);
//
//    KeyMetadata bobKeyMetadata = KeyMetadata.builder().from(KeyMetadata.EMPTY)
//      .keyIdentifier("bob")
//      .build();
//    final Address bobAddress = AddressUtils.getInstance()
//      .deriveAddress(signatureService.getPublicKey(bobKeyMetadata));
...
//      .build();
//    final Address destinationAddress = AddressUtils.getInstance()
//      .deriveAddress(signatureService.getPublicKey(destinationKeyMetadata));
...
//        )
//      )
//      .signingPublicKey(toPublicKey(sourceKeyMetadata, signatureService).base16Value())
//      .build();
//
//    SingleSingedTransaction<SignerListSet> signedSignerListSet = signatureService.sign(
...
//      .map(keyMetadata -> {
//          SignatureWithKeyMetadata signatureWithKeyMetadata = signatureService.multiSign(keyMetadata,
//            unsignedPayment);
//          return SignerWrapper.of(Signer.builder()
//            .account(toAddress(keyMetadata, signatureService))
//            .signingPublicKey(toPublicKey(keyMetadata, signatureService).base16Value())
...
//    );
  ...
  private PublicKey toPublicKey(
    final KeyMetadata keyMetadata, final DelegatedSignatureService delegatedSignatureService
  ) {

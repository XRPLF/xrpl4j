...
public interface PedersenCommitmentGenerator {
   ...
   *
   * @return A {@link PedersenCommitment} containing the 33-byte compressed commitment.
   *
   * @throws NullPointerException  if any parameter is null.
   * @throws IllegalStateException if commitment generation fails.
   */
  PedersenCommitment generateCommitment(UnsignedLong amount, BlindingFactor blindingFactor);
}

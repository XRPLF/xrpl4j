...
/**
 * Tests for {@link BcPedersenLinkProofVerifierPort}.
 */
class BcPedersenLinkProofVerifierPortTest {

  private static List<TestVector> testVectors;
  private static PedersenLinkProofVerifierPort verifier;

  @BeforeAll
  static void loadTestVectors() throws Exception {
    ObjectMapper mapper = new ObjectMapper();
    InputStream is = BcPedersenLinkProofVerifierPortTest.class
    ...
    verifier = new BcPedersenLinkProofVerifierPort();
  }

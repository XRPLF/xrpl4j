...
/**
 * Test for {@link BcSamePlaintextProofGeneratorPort} comparing output with C implementation.
 *
 ...
 */
class BcSamePlaintextProofGeneratorPortTest {
  ...
  static void loadTestVectors() throws Exception {
    InputStream is = BcSamePlaintextProofGeneratorPortTest.class.getResourceAsStream(
  ...
  void proofGenerationMatchesCImplementation() {
    for (JsonNode vector : testVectors.get("vectors")) {
      ...
      SamePlaintextProofGeneratorPort generator = new BcSamePlaintextProofGeneratorPort(mockGenerator);
      ...
      SamePlaintextProofVerifierPort verifier = new BcSamePlaintextProofVerifierPort();
  ...
  void testGenerateAndVerifyWithRandomNonces() {
    ...
    SamePlaintextProofGeneratorPort generator = new BcSamePlaintextProofGeneratorPort();
    SamePlaintextProofVerifierPort verifier = new BcSamePlaintextProofVerifierPort();

...
/**
 * Unit tests for {@link LoanDelete} validation logic.
 */
class LoanDeleteTest {
  ...
  @Test
  void validLoanDelete() {
    assertDoesNotThrow(() -> baseBuilder().build());
  }

  private ImmutableLoanDelete.Builder baseBuilder() {
    return LoanDelete.builder()

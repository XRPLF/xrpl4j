...
public class AbstractSignatureServiceTest {
  ...
  public void signWithNullTransaction() {
    assertThrows(NullPointerException.class, () -> signatureService.sign(keyMetadataMock, null));
  }
  ...
  public void verifyWithNullTransaction() {
    assertThrows(NullPointerException.class, () -> signatureService.verify(keyMetadataMock, null));
  }

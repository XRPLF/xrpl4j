...
import org.xrpl.xrpl4j.crypto.mpt.port.PlaintextEqualityProofVerifierPort;
import org.xrpl.xrpl4j.crypto.mpt.port.bc.BcPlaintextEqualityProofVerifierPort;
...
public class BcConfidentialMPTClawbackProofVerifier implements ConfidentialMPTClawbackProofVerifier {
  ...
  private final PlaintextEqualityProofVerifierPort proofVerifierPort;

  /**
   * Creates a new instance with default port implementation.
   */
  public BcConfidentialMPTClawbackProofVerifier() {
    this(new BcPlaintextEqualityProofVerifierPort());
  }
   ...
   */
  public BcConfidentialMPTClawbackProofVerifier(final PlaintextEqualityProofVerifierPort proofVerifierPort) {

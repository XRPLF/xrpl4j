...
public interface SamePlaintextProofVerifier {
  /**
   * Verifies that all ciphertexts in the participant list encrypt the same plaintext amount.
   *
   * @param proof        The proof to verify.
   * @param participants The list of participants (each with ciphertext and publicKey).

...
public class AccountSponsoringResultTest {
  ...
  public void buildWithAllFields() {
    ...
    CheckObject check = CheckObject.builder()
      .account(Address.of("rN7n7otQDd6FczFgLdSqtcsAUxDkw6fzRH"))
      .destination(Address.of("rfkE1aSy9G8Upk4JssnwBxhEv5p4mn2KTy"))
      .ownerNode("0000000000000000")
      .previousTxnId(Hash256.of("F0AB71E777B2DA54B86231E19B82554EF1F8211F92ECA473121C655BFC5329BF"))
    ...
    AccountSponsoringResult result = AccountSponsoringResult.builder()
      .account(Address.of("rN7n7otQDd6FczFgLdSqtcsAUxDkw6fzRH"))
      .sponsoredObjects(Collections.singletonList(check))
    ...
    assertThat(result.sponsoredObjects().get(0)).isInstanceOf(CheckObject.class);
    assertThat(((CheckObject) result.sponsoredObjects().get(0)).sponsor()).isPresent()

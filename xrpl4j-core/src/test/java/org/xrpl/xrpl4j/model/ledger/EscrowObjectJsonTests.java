...
public class EscrowObjectJsonTests extends AbstractJsonTest {
  ...
  @Test
  public void testJsonWithXrp() throws JsonProcessingException, JSONException {
  ...
  @Test
  public void testJsonWithIssuedCurrency() throws JsonProcessingException, JSONException {
    EscrowObject object = EscrowObject.builder()
      .account(Address.of("rf1BiGeXwwQoi8Z2ueFYTEXSwuJYfV2Jpn"))
      ...
      .ownerNode("0000000000000000")
      .destinationNode("0000000000000000")
      .issuerNode("0000000000000001")
      .transferRate(UnsignedInteger.valueOf(1002000000))
      .previousTransactionId(Hash256.of("C44F2EB84196B9AD820313DBEBA6316A15C9A2D35787579ED172B87A30131DA7"))
      .previousTransactionLedgerSequence(UnsignedInteger.valueOf(28991004))
      .sourceTag(UnsignedInteger.valueOf(11747))
      .index(Hash256.of("DC5F3851D8A1AB622F957761E5963BC5BD439D5C24AC6AD7AC4523F0640244AC"))
  ...
  @Test
  public void testJsonWithMptCurrency() throws JsonProcessingException, JSONException {
    EscrowObject object = EscrowObject.builder()
      .account(Address.of("rf1BiGeXwwQoi8Z2ueFYTEXSwuJYfV2Jpn"))
      ...
      .ownerNode("0000000000000000")
      .destinationNode("0000000000000000")
      .issuerNode("0000000000000002")
      .transferRate(UnsignedInteger.valueOf(500))
      .previousTransactionId(Hash256.of("C44F2EB84196B9AD820313DBEBA6316A15C9A2D35787579ED172B87A30131DA7"))
      .previousTransactionLedgerSequence(UnsignedInteger.valueOf(28991004))
      .sourceTag(UnsignedInteger.valueOf(11747))
      .index(Hash256.of("DC5F3851D8A1AB622F957761E5963BC5BD439D5C24AC6AD7AC4523F0640244AC"))

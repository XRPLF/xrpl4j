...
/**
 * Test for {@link BcSecretKeyProofGenerator} comparing output with C implementation.
 */
public class BcSecretKeyProofGeneratorTest {
  ...
  static void loadTestVectors() throws Exception {
    InputStream is = BcSecretKeyProofGeneratorTest.class.getResourceAsStream("/mpt/port/pok_sk_vectors.json");
  ...
  void proofGenerationMatchesCImplementation() {
    for (JsonNode vector : testVectors.get("vectors")) {
      ...
      SecretKeyProofGenerator generator = new BcSecretKeyProofGenerator(mockGenerator);

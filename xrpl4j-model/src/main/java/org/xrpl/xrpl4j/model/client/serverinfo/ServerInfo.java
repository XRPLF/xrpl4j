...
public interface ServerInfo {
   ...
   *
   * @param rippledServerInfoHandler       A {@link Consumer} that is called if this instance is of type {@link
   *                                       RippledServerInfo}.
   * @param clioServerInfoHandler          A {@link Consumer} that is called if this instance is of type {@link
   *                                       ClioServerInfo}.
   * @param reportingModeServerInfoHandler A {@link Consumer} that is called if this instance is of type {@link
   ...
   *
   * @param rippledServerInfoMapper       A {@link Function} that is called if this instance is of type {@link
   *                                      RippledServerInfo}.
   * @param clioServerInfoMapper          A {@link Function} that is called if this instance is  of type {@link
   *                                      ClioServerInfo}.
   * @param reportingModeServerInfoMapper A {@link Function} that is called if this instance is  of type {@link
   *                                      ReportingModeServerInfo}.

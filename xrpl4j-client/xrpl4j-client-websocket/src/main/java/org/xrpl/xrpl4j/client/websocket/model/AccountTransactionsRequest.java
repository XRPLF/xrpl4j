...
import org.xrpl.xrpl4j.client.websocket.jackson.AccountTransactionsRequestParamsDeserializer;
 ...
 */
@Value.Immutable
@JsonSerialize(as = ImmutableAccountTransactionsRequest.class)
@JsonDeserialize(
  as = ImmutableAccountTransactionsRequest.class,
  using = AccountTransactionsRequestParamsDeserializer.class
)
public interface AccountTransactionsRequest extends WebSocketRequest {
  
  /**
   * Construct a builder for this class.
   *
   * @return An {@link ImmutableAccountTransactionsRequest.Builder}.
   */
  static ImmutableAccountTransactionsRequest.Builder unboundedBuilder() {
    return ImmutableAccountTransactionsRequest.builder();
  }
   ...
   * @return An {@link ImmutableAccountTransactionsRequest.Builder}.
   */
  static ImmutableAccountTransactionsRequest.Builder builder(LedgerSpecifier ledgerSpecifier) {
    return ImmutableAccountTransactionsRequest.builder().ledgerSpecifier(ledgerSpecifier);
  }
  
  /**
   * Construct a builder for this class with {@link LedgerIndexBound}s specified for the {@link #ledgerIndexMinimum} and
   * {@link #ledgerIndexMaximum} fields.
   *
   ...
   * @return An {@link ImmutableAccountTransactionsRequest.Builder}.
   */
  static ImmutableAccountTransactionsRequest.Builder builder(
  ...
  /**
   * The earliest ledger to include transactions from. A value of {@code -1} instructs the server to use the earliest
   ...
   * {@link LedgerIndexShortcut#VALIDATED}.</p>
   *
   ...
   * ordered.)
   *
   * @return {@code true} if values should be indexed with the oldest ledger first, otherwise {@code false}. Defaults to
   *   {@code false}.
   */
  @Value.Default
  ...
  /**
   * Value from a previous paginated response. Resume retrieving data where that response left off. This value is stable
   * even if there is a change in the server's range of available ledgers.
   *
  ...
  /**
   * Nullifies {@link #ledgerIndexMinimum()} and {@link #ledgerIndexMaximum()} if {@link #ledgerSpecifier()} is
   * present.
   *
   * @return An {@link AccountTransactionsRequest}.
   */
  @Value.Check
  default AccountTransactionsRequest emptyBoundedParametersIfSpecifierPresent() {

...
public interface ElGamalCiphertext {
   ...
   *
   * @return An {@link ImmutableElGamalCiphertext.Builder}.
   */
  static ImmutableElGamalCiphertext.Builder builder() {
    return ImmutableElGamalCiphertext.builder();
  }
   ...
   *
   * @return A new {@link ElGamalCiphertext}.
   *
   * @throws IllegalArgumentException if c1 or c2 is not exactly 33 bytes.
   */
  static ElGamalCiphertext of(UnsignedByteArray c1, UnsignedByteArray c2) {
   ...
   */
  static ElGamalCiphertext fromBytes(byte[] bytes) {
   ...
   */
  static ElGamalCiphertext fromBytes(UnsignedByteArray value) {
   ...
   */
  static ElGamalCiphertext fromHex(String hex) {

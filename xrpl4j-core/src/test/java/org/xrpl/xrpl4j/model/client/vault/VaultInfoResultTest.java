    ...
    VaultInfoResult result = VaultInfoResult.builder()
      .vault(
        VaultObject.builder()
          ...
          .asset(Issue.XRP)
          .assetsTotal(Amount.builder().value("1000000").build())
          .assetsAvailable(Amount.builder().value("800000").build())
          .assetsMaximum(Amount.builder().value("0").build())
          .lossUnrealized(Amount.builder().value("0").build())

...
public class SingleAssetVaultIT extends AbstractIT {
  ...
  void vaultWithIouAsset() throws Exception {
    ...
    VaultCreate vaultCreate = VaultCreate.builder()
      ...
      .asset(usdIssue)
      .assetsMaximum(Amount.builder().value("500000").build())
    ...
    assertThat(vaultFromInfoById.assetsMaximum()).isEqualTo(Amount.builder().value("500000").build());
    ...
    assertThat(vaultFromInfoById.assetsTotal()).isEqualTo(Amount.builder().value("0").build());
    assertThat(vaultFromInfoById.assetsAvailable()).isEqualTo(Amount.builder().value("0").build());
    ...
    assertThat(vaultInfoAfterDeposit.vault().assetsTotal()).isEqualTo(Amount.builder().value("10000").build());
    assertThat(vaultInfoAfterDeposit.vault().assetsAvailable()).isEqualTo(Amount.builder().value("10000").build());
    ...
    assertThat(vaultInfoAfterWithdraw.vault().assetsTotal()).isEqualTo(Amount.builder().value("6000").build());
    assertThat(vaultInfoAfterWithdraw.vault().assetsAvailable()).isEqualTo(Amount.builder().value("6000").build());
    ...
    assertThat(vaultInfoAfterClawback.vault().assetsTotal()).isEqualTo(Amount.builder().value("4000").build());
    assertThat(vaultInfoAfterClawback.vault().assetsAvailable()).isEqualTo(Amount.builder().value("4000").build());
    ...
    assertThat(vaultInfoAfterSet.vault().assetsMaximum()).isEqualTo(Amount.builder().value("1000000").build());
    assertThat(vaultInfoAfterSet.vault().data()).isNotEmpty().get().isEqualTo(VaultData.of("576F726C64"));
    assertThat(vaultInfoAfterSet.vault().assetsTotal()).isEqualTo(Amount.builder().value("4000").build());
  ...
  void vaultWithMptAsset() throws Exception {
    ...
    VaultCreate vaultCreate = VaultCreate.builder()
      ...
      .sequence(vaultOwnerAccountInfo.accountData().sequence())
      .asset(mptIssue)
      .assetsMaximum(Amount.builder().value("50000000").build())
    ...
    assertThat(vaultFromInfoById.assetsMaximum()).isEqualTo(Amount.builder().value("50000000").build());
    ...
    // Verify vault state after clawback
    VaultInfoResult vaultInfoAfterClawback = xrplClient.vaultInfo(VaultInfoRequestParams.of(vaultId));
    assertThat(vaultInfoAfterClawback.vault().assetsTotal()).isEqualTo(Amount.builder().value("8000").build());
    assertThat(vaultInfoAfterClawback.vault().assetsAvailable()).isEqualTo(Amount.builder().value("8000").build());
    ...
    VaultInfoResult vaultInfoAfterWithdraw = xrplClient.vaultInfo(VaultInfoRequestParams.of(vaultId));
    assertThat(vaultInfoAfterWithdraw.vault().assetsTotal()).isEqualTo(Amount.builder().value("4000").build());
    assertThat(vaultInfoAfterWithdraw.vault().assetsAvailable()).isEqualTo(Amount.builder().value("4000").build());
    ...
    VaultSet vaultSet = VaultSet.builder()
      ...
      .sequence(vaultOwnerAccountInfo.accountData().sequence())
      .vaultId(vaultId)
      .assetsMaximum(Amount.builder().value("100000000").build())
    ...
    VaultInfoResult vaultInfoAfterSet = xrplClient.vaultInfo(VaultInfoRequestParams.of(vaultId));
    assertThat(vaultInfoAfterSet.vault().assetsMaximum()).isEqualTo(Amount.builder().value("100000000").build());
  ...
  void vaultWithXrpAsset() throws Exception {
    ...
    VaultCreate vaultCreate = VaultCreate.builder()
      ...
      .sequence(vaultOwnerAccountInfo.accountData().sequence())
      .asset(Issue.XRP)
      .assetsMaximum(Amount.builder().value("10000000000").build())
    ...
    assertThat(vaultFromInfoById.assetsMaximum()).isEqualTo(Amount.builder().value("10000000000").build());
    assertThat(vaultFromInfoById.scale()).isEqualTo(AssetScale.of(UnsignedInteger.ZERO));
    ...
    VaultInfoResult vaultInfoAfterDeposit = xrplClient.vaultInfo(VaultInfoRequestParams.of(vaultId));
    assertThat(vaultInfoAfterDeposit.vault().assetsTotal()).isEqualTo(Amount.builder().value("1000000").build());
    assertThat(vaultInfoAfterDeposit.vault().assetsAvailable()).isEqualTo(Amount.builder().value("1000000").build());
    assertThat(vaultInfoAfterDeposit.vault().shares()).isNotEmpty();
    ...
    VaultInfoResult vaultInfoAfterWithdraw = xrplClient.vaultInfo(VaultInfoRequestParams.of(vaultId));
    assertThat(vaultInfoAfterWithdraw.vault().assetsTotal()).isEqualTo(Amount.builder().value("500000").build());
    assertThat(vaultInfoAfterWithdraw.vault().assetsAvailable()).isEqualTo(Amount.builder().value("500000").build());
    ...
    VaultSet vaultSet = VaultSet.builder()
      ...
      .sequence(vaultOwnerAccountInfo.accountData().sequence())
      .vaultId(vaultId)
      .assetsMaximum(Amount.builder().value("20000000000").build())
    ...
    VaultInfoResult vaultInfoAfterSet = xrplClient.vaultInfo(VaultInfoRequestParams.of(vaultId));
    assertThat(vaultInfoAfterSet.vault().assetsMaximum()).isEqualTo(Amount.builder().value("20000000000").build());
    assertThat(vaultInfoAfterSet.vault().data()).isNotEmpty().get().isEqualTo(VaultData.of("4E4557"));
    assertThat(vaultInfoAfterSet.vault().assetsTotal()).isEqualTo(Amount.builder().value("500000").build());

...
public class JavaElGamalBalanceDecryptorTest extends AbstractElGamalTest {
  ...
  void testDecryptionFailsForLargeAmount() {
    ...
    final byte[] privateKeyBytes = keyPair.privateKey().naturalBytes().toByteArray();
    ...
    assertThatThrownBy(() -> javaElGamalBalanceDecryptor.decrypt(ciphertext, privateKeyBytes))

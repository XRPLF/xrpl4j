...
import org.xrpl.xrpl4j.crypto.mpt.elgamal.ElGamalDecryptor;
 ...
 * with in-memory {@link PrivateKey} instances.</p>
 *
 * <p><strong>WARNING:</strong> This implementation uses in-memory private key material.</p>
 *
 * @see ElGamalDecryptor
 * @see PrivateKey
 */
public class BcElGamalDecryptor implements ElGamalDecryptor<PrivateKey> {

  /**
   * Constructs a new {@link BcElGamalDecryptor} instance.
   */
  ...
  public long decrypt(
    ...
    BigInteger privKeyScalar = Secp256k1Operations.toScalar(privateKey);

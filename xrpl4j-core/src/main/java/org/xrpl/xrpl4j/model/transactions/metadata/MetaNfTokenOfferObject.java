...
/**
 * An Offer returned in an {@link MetaNfTokenOfferObject} list.
 * Note that this object is NOT the same as the Offer ledger object.
 */
@Value.Immutable
@JsonSerialize(as = ImmutableMetaNfTokenOfferObject.class)
@JsonDeserialize(as = ImmutableMetaNfTokenOfferObject.class)
public interface MetaNfTokenOfferObject extends MetaLedgerObject {
   ...
   *
   * @return {@link NfTokenId} of the NfToken.
   */

...
public abstract class AbstractIT {
  ...
  public static final String SUCCESS_STATUS = TransactionResultCode.TES_SUCCESS;
  ...
  public TrustLine createTrustLine(
    ...
    assertThat(trustSetSubmitResult.result()).isEqualTo(TransactionResultCode.TES_SUCCESS);

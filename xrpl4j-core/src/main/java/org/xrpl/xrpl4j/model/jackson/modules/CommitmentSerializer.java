...
/**
 * Custom Jackson serializer for {@link Commitment}s.
 */
public class CommitmentSerializer extends StdScalarSerializer<Commitment> {

  /**
   * No-args constructor.
   */
  public CommitmentSerializer() {
    super(Commitment.class, false);
  }
